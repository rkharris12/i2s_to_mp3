...
create_clock -add -name i2s_clk_pin -period 500.00 -waveform {0 250} [get_ports { I2S_BCK }];

## Clock groups

set_clock_groups -group [get_clocks -include_generated_clocks i2s_clk_pin] -asynchronous
...
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { I2S_BCK }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { I2S_LRCK }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { I2S_DATA }]; #IO_L22P_T3_34 Sch=ja_p[4]
